...
== Adoption ==
TypeScript has grown quickly since its 2012 release. In Stack Overflow's 2025 Developer Survey of 49,000+ developers, around 38% of professionals reported using it, fifth overall among programming languages. It first appeared in the survey in 2016 with under 1% usage.
By 2025, TypeScript had become the most-used language on GitHub by pull request volume, surpassing JavaScript and Python for the first time, according to GitHub's Octoverse report.
Growth has been driven largely by framework adoption. Angular uses it as its primary language and it has become standard across most React and Node.js projects.
